...
var/global/list/datum/stack_recipe/metal_recipes = list (
	...
	new/datum/stack_recipe_list("airlock assemblies", list(
		...
		new/datum/stack_recipe("Police of Utopia airlock assembly", /obj/structure/door_assembly/door_assembly_sec, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE),
...
/*		new/datum/stack_recipe("science airlock assembly", /obj/structure/door_assembly/door_assembly_science, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE), \ */
		...
		new/datum/stack_recipe("high Police of Utopia airlock assembly", /obj/structure/door_assembly/door_assembly_highsecurity, 4, time = 50, one_per_turf = TRUE, on_floor = TRUE),
