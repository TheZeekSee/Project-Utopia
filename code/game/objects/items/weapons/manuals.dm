...
/obj/item/weapon/book/manual/detective
	...
	dat = {"<html>
				...
				<ol>
					...
					<li>Assuming you have enough of a print to see it, grab the biggest complete piece of the print and search the Police of Utopia records for it. </li>
					<li>Since you now have both your dossier and the name of the person, print both out as evidence and get Police of Utopia to nab your baddie.</li>
