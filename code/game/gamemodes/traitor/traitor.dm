...
/datum/game_mode/traitor
	...
	protected_jobs = list("Police Cadet", "Internal Affairs Agent", "Police Officer", "Warden", "Detective", "Head of Police of Utopia", "Captain", "Velocity Officer", "Velocity Chief", "Velocity Medical Doctor")//AI", Currently out of the list as malf does not work for shit
	required_players = 1
	required_enemies = 1
