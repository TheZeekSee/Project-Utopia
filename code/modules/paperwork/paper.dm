...
/obj/item/weapon/paper/RemControl
	name = "Remote Control Tutorial"
	info = "This is a tutorial on remote control of departments. All the buttons are signed, so you shouldn't get lost. The remote control buttons shut down any department in an emergency. The same buttons are also available for department heads."
